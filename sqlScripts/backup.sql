...
--
-- Host: localhost    Database: wilderness
-- ------------------------------------------------------
...
/*!50001 VIEW `taskView` AS select `task`.`id` AS `id`,`task`.`title` AS `title`,`task`.`tech` AS `tech`,`task`.`tOrder` AS `torder`,`task`.`tGroup` AS `tgroup` from `task` */;
...
-- Dump completed on 2021-07-11  0:20:54
